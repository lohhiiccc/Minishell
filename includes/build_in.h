...
/*   Updated: 2024/04/30 22:01:02 by mjuffard         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
# define ERR_EXP_ID "Minichel: export: %s: not a valid identifier\n"
# define ERR_ECHO "Minichel: echo: %s\n"
# define ERR_EXIT_TOO_MANY_ARGS "Minichel: exit: too many argument\n"
# define USE_EQ "Minichel: export: usage is [varname]=[value]\n"
